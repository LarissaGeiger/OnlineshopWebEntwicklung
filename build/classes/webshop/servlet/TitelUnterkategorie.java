...
@WebServlet("/TitelUnterkategorie")
public class TitelUnterkategorie extends HttpServlet {
...
*/
		...
		request.getRequestDispatcher("jsp/produktDetailPage.jsp").include(request, response);
